...
- [DSS](https://github.com/MONICA-Project/scral-framework) - Decision Support Systems that creates incidents.
- [LoRaWAN GPS Tracker](https://github.com/MONICA-Project/lorawan-tracker) - RIOT-OS based GPS tracking devices using LoRaWAN.
...
![IoT Database](https://github.com/MONICA-Project/DockerEnvironmentSensorDemo/blob/master/img/iot-db.png "GOST") 



#### 2, Start up the Simulator:

```bash
docker-compose up -d simulator
```

Check ifit is up is up and running at http://localhost:8090/v1.0/Datastreams.
You should see 9 datastreams defined.

![Datastreams](https://github.com/MONICA-Project/DockerEnvironmentSensorDemo/blob/master/img/simulators.png "Datastream") 
...
**NB!** the userid is admin@monica-cop.com and the password DEMO!

![COP UI](https://github.com/MONICA-Project/DockerEnvironmentSensorDemo/blob/master/img/cop-ui.png "COP UI") 
